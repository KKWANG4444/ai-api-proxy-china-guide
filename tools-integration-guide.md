...
[![文章更新](https://img.shields.io/badge/更新-2026--05--24-green)](https://github.com/KKWANG4444/ai-api-proxy-china-guide)
...
| Base URL | `https://api.aifast.club/v1` |
...
export ANTHROPIC_BASE_URL="https://api.aifast.club/v1"
...
{
  "apiKey": "你的APIKey",
  "baseUrl": "https://api.aifast.club/v1"
}
```
...
| API Key | 你的 [www.aifast.club](https://www.aifast.club) API Key |
| API Base URL | `https://api.aifast.club/v1` |
...
|------|-----|
| 名称 | 随便填（如 `aifast`） |
| API 地址 | `https://api.aifast.club/v1` |
| API Key | 你的 API Key |
...
| 参数 | 值 |
|------|-----|
| API 代理地址 | `https://api.aifast.club/v1` |
| API Key | 你的 API Key |
...
docker run -d -p 3000:3000 \
  -e BASE_URL=https://api.aifast.club/v1 \
  -e API_KEY=你的APIKey \
  -e CODE=访问密码 \
...
| 参数 | 值 |
|------|-----|
| API URL | `https://api.aifast.club/v1` |
| API Key | 你的 API Key |
| Prefix ID | 留空或填 `gpt-` |
...
- API Key 有没有复制的空格
- 网络能不能访问 api.aifast.club（国内一般没问题）
