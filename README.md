...
[![OpenAI API](https://img.shields.io/badge/OpenAI API_Sol🌞-已上线-orange)](https://www.aifast.club)
...
- **豆包（字节跳动）：** Doubao Seed 2.1 Pro / Turbo 等
...
**推荐模型：`qwen3.7-max`**
如果业务对数据安全要求高、需要遵守国内法规，阿里百炼的 Qwen3.7-Max 是最稳妥的选择。数据不出境，完全合规。
...
| 智谱 | GLM-5.2 | `glm-5.2` |
| 字节豆包 | Seed 2.1 Pro / Turbo | `doubao-seed-2-1-pro-260628`、`doubao-seed-2-1-turbo-260628` |
